...
<div id="page-wrapper">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-heading"> 
			<i class="fa fa-plus-circle"></i> Crear Nuevo Proceso de Servicio 
		</div>
		...
		echo form_open(base_url().'index.php/cargar_datos/servicio_procesos/crear',$attributes); 
		?>
		...
		<div class="form-group">
				        <div class="required">
							<label for="prioridad_servicio" class="col-md-4 control-label">Tipo de Prioridad</label>		    
						</div>
						...
						<div class="col-md-2">
				            ...
				            <?php echo form_dropdown('tipo_proceso_servicio', $options,set_value('tipo_proceso_servicio'),'class="form-control" id="dropdown_tipo_proceso_servicio"'); ?>
				        </div>
				    </div>
