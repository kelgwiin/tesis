...
<div id="page-wrapper">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-heading">
	   		<h3 class="panel-title"> <i class="fa fa-folder-open-o"></i> Categor&#237;as de Servicio</h3>
	  	</div>
                            ...
                            <table class="table table-bordered table-striped table-hover" id="dataTables-categorias">
                                ...
                                <tbody>
                                	...
                                	foreach($servicio_categorias as $servicio_categoria)
		           					 { ?>
		           						<tr id="<?php echo $servicio_categoria->categoria_id; ?>" class="text-left">

							                <td> <?php $data = array(
											    'name'        => 'checkbox_'.$servicio_categoria->categoria_id,
											    'id'          => 'checkbox_'.$servicio_categoria->categoria_id,
											    'class'       =>  'checkbox',
											    'value'       => $servicio_categoria->categoria_id,
											    'checked'     => FALSE,
											    );

											echo form_checkbox($data); ?> </td>
							                <td> <?php echo $servicio_categoria->nombre; ?>  </td>
							                <td> <?php 
                                                  if(strlen($servicio_categoria->descripcion)> 300)
                                                        {       
                                                                $conntent = substr($servicio_categoria->descripcion, 0, 300);
                                                                echo $conntent.' (...)';                                                       
                                                        }
                                                   else
                                                        {
                                                                echo $servicio_categoria->descripcion;
                                                       
                                                        }     
							                			//echo $proceso->descripcion; ?> </td>
							                <td class="text-center"> <a href="<?php echo base_url().'index.php/cargar_datos/servicio_categorias/ver/'.$servicio_categoria->categoria_id ?>" type="button" class="btn btn-info btn-xs" data-toggle="tooltip" data-placement="top" title="Ver"><i class="fa fa-search"></i></a> 
							                	 <a href="<?php echo base_url().'index.php/cargar_datos/servicio_categorias/modificar/'.$servicio_categoria->categoria_id ?>" type="button" class="btn btn-warning btn-xs" data-toggle="tooltip" data-placement="top" title="Actualizar"><i class="fa fa-pencil"></i></a>
							                	 <a type="button" class="btn btn-danger btn-xs" onclick="deleteCategoria(<?php echo $servicio_categoria->categoria_id; ?>);" data-toggle="tooltip" data-placement="top" title="Eliminar"><i class="fa fa-times"></i></a> </td>
							            </tr>
							         <?php } ?>    
                                </tbody>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body text-center">
		        <p><div class="alert alert-danger" role="alert"><i class="fa fa-exclamation-triangle"></i> ¿Est&#225; seguro que desea <b>Eliminar</b> esta Categor&#237;a de Servicio?</div></p>
		      </div>
	...
	<div class="modal fade" id="eliminar_todos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body text-center">
		        <p><div class="alert alert-danger" role="alert"><i class="fa fa-exclamation-triangle"></i> ¿Est&#225; seguro que desea <b>Eliminar TODAS</b> las Categor&#237;as de Servicio Seleccionadas?</div></p>
		      </div>
		      <div class="modal-footer">
