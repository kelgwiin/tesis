...
<h3> <b>Nombre del Documento de Requisitos</b></h3> <hr><br>
  ...
  <div class="row">
		 <div class="form-group">
			    ...
			    <div class="col-md-7">
			       <input type='text' name="nombre_requisito" class="form-control" id='nombre_requisito' value="<?php echo set_value('nombre_requisito',@$requisito->nombre); ?>"/>
  ...
  <div class="row">
	 ...
	 <div class="form-group">
		...
		?>
		 ...
		 <?php echo form_dropdown('servicio', $options,set_value('servicio',@$requisito->id_servicio),'class="form-control" id="dropdown_servicio" '); ?>	
	 	</div>
	 </div>	 
 ...
 <div class="row">
	  ...
	  <div class="form-group">
			...
			<div class="col-md-6">
			 <?php $data = array(
			       'value' => set_value('clientes',@$requisito->cliente),
		            'name'        => 'clientes',
		            'id'          => 'clientes', 
