...
<div id="page-wrapper">
	...
	<div class="panel panel-primary" id='menu_pasos_ans'>
		...
		<div class="panel-heading">
	   		<i class="fa fa-plus-circle"></i> Crear Nuevo Requisito de Niveles de Servicio
	  	</div>
	  	...
	  	<?php
			...
			echo form_open_multipart(base_url().'index.php/requisito_niveles_servicio/gestion_RNS/crear_RNS',$attributes); 
	      ?>
	  		<br>
			    ...
			    <div class="row setup-content" id="step-1">
			        <div class="col-md-12">
			            <div class="col-md-12 well">
			                ...
			                <?php $this->load->view('niveles/rns/paso1'); ?>
			            </div>
			        </div>
			    </div>
			    <div class="row setup-content" id="step-3">
			        <div class="col-md-12">
			            <div class="col-md-12 well">
			                <?php $this->load->view('niveles/rns/paso2'); ?>
			            </div>
			        </div>
			    </div>
			     <div class="row setup-content" id="step-4">
			        <div class="col-md-12">
			            <div class="col-md-12 well">
			                <?php $this->load->view('niveles/rns/paso3'); ?>
			            </div>
			        </div>
			    </div>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		      ...
		      <div class="modal-body text-center">
		        <p><div class="alert alert-danger" role="alert"><i class="fa fa-exclamation-triangle"></i> ¿Est&#225; seguro que desea <b>Salir de la Sección de Creación de RNS</b>?<br>
