...
<div id="page-wrapper">
	...
	<div class="col-lg-12">
    	<h1>Comunicaciones del Servicio: <?php echo $nombre_servicio; ?></h1>
        
        <ol class="breadcrumb">
          <li class="active"><i class="fa fa-dashboard"></i> Consumo de Red del Servicio: <?php echo $nombre_servicio; ?></li>
        </ol>
        
        <div class="alert alert-success alert-dismissable">
          <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
          En este apartado se puede verificar el tráfico en la red de los distintos canales internos del servicio '<?php echo $nombre_servicio; ?>'
        </div>
	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<h2>Tasa de Uso de Red del Servicio: <?php echo $nombre_servicio; ?></h2>
