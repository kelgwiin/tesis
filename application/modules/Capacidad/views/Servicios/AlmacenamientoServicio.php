...
<div id="page-wrapper">
	...
	<div class="col-lg-12">
    	<h1>Almacenamiento del Servicio: <?php echo $nombre_servicio; ?></h1>
        
        <ol class="breadcrumb">
          <li class="active"><i class="fa fa-dashboard"></i> Consumo de Discos del Servicio: <?php echo $nombre_servicio; ?></li>
        </ol>
	...
	<div class="col-lg-12">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<h2>Tasa uso en Discos del Servicio: <?php echo $nombre_servicio; ?></h2>
