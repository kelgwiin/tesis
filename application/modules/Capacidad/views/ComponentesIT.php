...
<div id="page-wrapper">
	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
          <li class="active"><i class="fa fa-dashboard"></i> Procesador</li>
        </ol>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Porcentaje de uso CPU</h3>
	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
          <li class="active"><i class="fa fa-dashboard"></i> Memoria RAM</li>
        </ol>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Tasa de uso de RAM</h3>
	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
          <li class="active"><i class="fa fa-dashboard"></i> Almacenamiento</li>
        </ol>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-info">
			...
			<div class="panel-heading">
				...
				<h3 class="panel-title">Tasa de Uso de Disco</h3>
