...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2014 a las 17:13:01
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Representa el catÃ¡logo de servicios de la infaestructura de' AUTO_INCREMENT=3 ;

--
-- Volcado de datos para la tabla `servicio`
--

INSERT INTO `servicio` (`servicio_id`, `nombre`, `descripcion`, `caracteristicas`, `fecha_creacion`, `categoria_servicio`, `tipo_servicio`, `propietario_servicio`, `prioridad_servicio`, `proveedor_servicio`, `fecha_modificado`, `genera_ingresos`, `cantidad_ingresos`, `borrado`) VALUES
(1, 'Primer Servicio', '<p>wedwedwd</p>', '<p>edwedwedwed</p>', '2014-08-31 18:30:42', 'Servicio de Bases de Datos', 'Servicio Orientado al Cliente', 3, 'Alta', 5, '2014-08-31 22:03:10', NULL, NULL, 0),
(2, 'Segundo Servicio', '<p>Segundo Servicio </p>', '<p>Otras Caracteristicas (modificado)</p>', '2014-08-31 19:19:14', 'Servicio de Infraestructura', 'Servicio de Soporte', 1, 'Media', 5, '2014-08-31 21:54:39', NULL, NULL, 0);
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Representa todos los procesos que se encuentrarÃ¡n asociados a un servicio previamente definido' AUTO_INCREMENT=12 ;
