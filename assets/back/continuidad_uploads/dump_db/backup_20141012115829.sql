...
CREATE TABLE `categorias_riesgos` (
  ...
  `fija` tinyint(4) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id_categoria`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;

INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (1, 'Desastres naturales', 'Eventos o fenómenos de factor climático o de la naturaleza que ocurren de forma al azar y representan un riesgo o amenaza para la organización.', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (2, 'Daños accidentales', 'Eventos de ocurren de forma fortuita, sin intención alguna pero que de igual forma representan un riesgo o amenaza para la organización.', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (3, 'Humano intencionado interno', 'Amenaza o riesgo efectuado de manera intencional por personal interno de la organización ', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (4, 'Humano intencionado externo', 'Amenaza o riesgo efectuado de manera intencional por personal externo a la organización ', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (5, 'Humano no intencionado externo', 'Amenaza o riesgo efectuado de manera no intencional por personal externo de la organización', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (6, 'Humano no intencionado interno', 'Amenaza o riesgo efectuado de manera no intencional por personal interno de la organización', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (7, 'Inactividad de procesos', 'Procesos pertenecientes a los Servicios de TI del sistema', 1);
INSERT INTO categorias_riesgos (`id_categoria`, `categoria`, `descripcion`, `fija`) VALUES (8, 'Misceláneos 1', 'Conjunto de categorías misceláneas cuyos riesgos no  comparten similitudes con las demás categorías', 0);
...
INSERT INTO estrategias_recuperacion (`id_estrategia`, `id_tipoestrategia`, `denominacion`, `costo`, `hardware`, `telecom`, `fecha_inicio`, `fecha_fin`, `localizacion`, `acotaciones`, `fecha_creacion`, `fecha_modificacion`) VALUES (5, 7, 'Reutilización-001', '0', 'Impresoras, Servidores, Monitores', 'Routers, Modems', '2014-09-01', '2016-12-01', 'Oficina central 001', '', '2014-10-12 00:00:00', '2014-10-12 10:20:04');
...
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8 COMMENT='Permite almacenar la contabilización total de los costos. Incluyendo los costos indirectos. De manera que esta información es la que se';

INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (115, 1, 2015, '2014-06-30 14:35:02');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (133, 5, 2014, '2014-10-07 16:18:08');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (134, 6, 2014, '2014-10-07 16:18:08');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (135, 7, 2014, '2014-10-07 16:18:09');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (136, 8, 2014, '2014-10-07 16:18:09');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (137, 9, 2014, '2014-10-07 16:18:09');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (138, 10, 2014, '2014-10-07 16:18:09');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (139, 11, 2014, '2014-10-07 16:18:10');
INSERT INTO estructura_costo (`estructura_costo_id`, `mes`, `anio`, `fecha_creacion`) VALUES (140, 12, 2014, '2014-10-07 16:18:10');
...
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (149, 133, 4, 1241245548544, '1462', '45', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (150, 134, 4, 1241245548544, '1462', '1155.6666666667', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (151, 134, 2, 150994944, '4140', '1155.6666666667', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (152, 134, 3, 32000000, '2323', '1155.6666666667', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (153, 135, 4, 1241245548544, '1462', '4.3333333333333', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (154, 135, 2, 150994944, '4140', '4.3333333333333', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (155, 135, 3, 32000000, '2323', '4.3333333333333', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (156, 136, 4, 1241245548544, '1462', '13', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (157, 137, 4, 1241245548544, '1462', '13', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (158, 138, 4, 1241245548544, '1462', '13', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (159, 139, 4, 1241245548544, '1462', '13', 1);
INSERT INTO estructura_costo_item (`estructura_costo_item_id`, `estructura_costo_id`, `ma_categoria_id`, `total_capacidad`, `total_monetario`, `total_monetario_cost_ind`, `cantidad_items`) VALUES (160, 140, 4, 1241245548544, '1462', '13', 1);
...
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (21, 4, 'continuidad_crearpcn');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (22, 4, 'continuidad_modificarpcn');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (23, 4, 'continuidad_eliminarpcn');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (24, 4, 'continuidad_listadobackup');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (25, 4, 'continuidad_crearbackup');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (26, 4, 'continuidad_listarequipos');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (27, 4, 'continuidad_crearequipos');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (28, 4, 'continuidad_eliminarequipo');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (29, 4, 'continuidad_listarestrategias');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (30, 4, 'continuidad_crearestrategia');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (31, 4, 'continuidad_modificarestrategia');
INSERT INTO modulo_hijo (`id_modulo_hijo`, `id_modulo_padre`, `modulo_hijo`) VALUES (32, 4, 'continuidad_eliminarestrategia');
...
INSERT INTO plan_continuidad (`id_continuidad`, `codigo`, `denominacion`, `id_riesgo`, `id_departamento`, `id_empleado`, `id_estado`, `id_estrategia`, `tipo_plan`, `id_crisis`, `desc_crisis`, `id_recuperacion`, `desc_recuperacion`, `id_logistica`, `desc_logistica`, `id_rrpp`, `desc_rrpp`, `id_pruebas`, `desc_pruebas`, `consideraciones`, `pdf`, `fecha_creacion`, `fecha_modificacion`) VALUES (6, 'PCN-Proc001', 'Reacción contra caída de proceso de TI', 23, 1, 1, 2, 2, 'reactivo', 1, 'El equipo de crisis debe evaluar en 10 minutos cuanto tiempo ha estado caido el proceso e indicar acciones a los demás equipos.', 4, 'Recuperación debe ir armando estaciones paralelas y estableciendo los monitores y conexiones necesarias.', 6, 'Recopilar cualquier infraestructura necesaria para el equipo de recuperación', 7, 'No informar de la caída hasta que el comité de crisis lo decida', 10, 'Una vez recuperado. Iniciar protocolos de pruebas', '', '/var/www/html/tesis/assets/back/continuidad_uploads/reaccion_contra_caida_de_proceso_de_ti.pdf', '2014-10-10 19:50:34', '2014-10-10 14:20:34');
INSERT INTO plan_continuidad (`id_continuidad`, `codigo`, `denominacion`, `id_riesgo`, `id_departamento`, `id_empleado`, `id_estado`, `id_estrategia`, `tipo_plan`, `id_crisis`, `desc_crisis`, `id_recuperacion`, `desc_recuperacion`, `id_logistica`, `desc_logistica`, `id_rrpp`, `desc_rrpp`, `id_pruebas`, `desc_pruebas`, `consideraciones`, `pdf`, `fecha_creacion`, `fecha_modificacion`) VALUES (7, 'PCN001', 'Fallo del proceso de impresión remota', 24, 2, 3, 2, 5, 'reactivo', 1, 'If needle is a string, the comparison is done in a case-sensitive manner.', 3, 'Searches haystack for needle using loose comparison unless strict is set.', 5, 'If the third parameter strict is set to TRUE then the in_array()', 7, 'Function will also check the types of the needle in the haystack.', 9, 'Returns TRUE if needle is found in the array, FALSE otherwise.', '', '/var/www/html/tesis/assets/back/continuidad_uploads/fallo_del_proceso_de_impresion_remota.pdf', '2014-10-12 17:22:50', '2014-10-12 11:52:50');
...
#
# TABLE STRUCTURE FOR: proceso_riesgo
#

DROP TABLE IF EXISTS proceso_riesgo;

CREATE TABLE `proceso_riesgo` (
  `id_riesgo` bigint(20) NOT NULL,
  `id_servicioproceso` bigint(20) NOT NULL,
  KEY `id_riesgo` (`id_riesgo`),
  KEY `id_servicioproceso` (`id_servicioproceso`),
  CONSTRAINT `proceso_riesgo_ibfk_1` FOREIGN KEY (`id_riesgo`) REFERENCES `riesgos_amenazas` (`id_riesgo`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `proceso_riesgo_ibfk_2` FOREIGN KEY (`id_servicioproceso`) REFERENCES `servicio_proceso` (`servicio_proceso_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO proceso_riesgo (`id_riesgo`, `id_servicioproceso`) VALUES (24, 19);


#
# TABLE STRUCTURE FOR: proceso_soporta_servicio
#

DROP TABLE IF EXISTS proceso_soporta_servicio;

CREATE TABLE `proceso_soporta_servicio` (
  `servicio_proceso_id` bigint(20) NOT NULL,
  `servicio_id` bigint(20) NOT NULL,
  PRIMARY KEY (`servicio_proceso_id`,`servicio_id`),
  CONSTRAINT `proceso_soporta_servicio_ibfk_1` FOREIGN KEY (`servicio_proceso_id`) REFERENCES `servicio_proceso` (`servicio_proceso_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (14, 1);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (15, 1);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (17, 1);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (18, 2);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (18, 3);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (18, 7);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (19, 1);
INSERT INTO proceso_soporta_servicio (`servicio_proceso_id`, `servicio_id`) VALUES (19, 2);
...
INSERT INTO respaldo_db (`id_respaldo`, `descripcion`, `ruta`, `fecha_creacion`) VALUES (1, 'Cierre de mes', '/var/www/html/tesis/assets/back/continuidad_uploads/dump_db/backup_20140930094418.sql', '2014-09-30 09:44:18');
...
INSERT INTO riesgos_amenazas (`id_riesgo`, `id_categoria`, `denominacion`, `probabilidad`, `impacto`, `valoracion`) VALUES (19, 5, 'Daños a la propiedad privada', 'Baja', 'Medio', 'Media-Baja');
...
INSERT INTO riesgos_amenazas (`id_riesgo`, `id_categoria`, `denominacion`, `probabilidad`, `impacto`, `valoracion`) VALUES (22, 6, 'Extravío de copias de seguridad', 'Baja', 'Alto', 'Media');
INSERT INTO riesgos_amenazas (`id_riesgo`, `id_categoria`, `denominacion`, `probabilidad`, `impacto`, `valoracion`) VALUES (23, 7, 'Caída del proceso de TI SBDS001', 'Baja', 'Medio-Alto', 'Media-Baja');
INSERT INTO riesgos_amenazas (`id_riesgo`, `id_categoria`, `denominacion`, `probabilidad`, `impacto`, `valoracion`) VALUES (24, 7, 'Fallo del proceso de impresión remota', 'Media', 'Alto', 'Media-Alta');
...
INSERT INTO roles (`id_rol`, `rol`) VALUES (2, 'gerente de tecnologías de información');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Representa el catálogo de servicios de la infaestructura de';

INSERT INTO servicio (`servicio_id`, `nombre`, `descripcion`, `fecha_creacion`, `genera_ingresos`, `cantidad_ingresos`, `borrado`, `categoria_servicio`, `tipo_servicio`, `propietario_servicio`, `proveedor_servicio`, `fecha_modificado`, `prioridad_servicio`, `impacto`, `procedimiento_solicitud`, `contacto`, `estatus`, `ruta_imagen`, `caracteristicas`) VALUES (1, 'Soporte de Base de Datos del sistema', '<p>Descripción del nuevo servicio de TI: Soporte de base de datos del sistema</p>', '2014-10-10 09:40:17', 0, NULL, 0, 'Servicio de Bases de Datos', 'Servicio de Soporte', 1, 5, NULL, 'Alta', '<p>Impacto en el negocio del nuevo servicio de TI: Soporte de base de datos del sistema</p>', '<p>Procedimiento de solicitud del nuevo servicio de TI: Soporte de base de datos del sistema</p>', '<p>Información de contacto del nuevo servicio de TI: Soporte de base de datos del sistema</p>', 'Activo', 'assets/imagenes/servicio/default.jpg', '<p>Características del nuevo servicio de TI: Soporte de base de datos del sistema</p>');
INSERT INTO servicio (`servicio_id`, `nombre`, `descripcion`, `fecha_creacion`, `genera_ingresos`, `cantidad_ingresos`, `borrado`, `categoria_servicio`, `tipo_servicio`, `propietario_servicio`, `proveedor_servicio`, `fecha_modificado`, `prioridad_servicio`, `impacto`, `procedimiento_solicitud`, `contacto`, `estatus`, `ruta_imagen`, `caracteristicas`) VALUES (2, 'Backup Bash', '<p>Respaldo masivo de la base de datos del servicio Backup Bach</p>', '2014-10-12 09:52:42', 0, NULL, 0, 'Servicio de Almacenamiento', 'Servicio de Soporte', 4, 6, NULL, 'Media', '<p>Impacto en el negocio de Respaldo masivo de la base de datos del servicio Backup Bach</p>', '<p>Procedimiento de solicitud de Respaldo masivo de la base de datos del servicio Backup Bach</p>', '<p>Información de contacto Respaldo masivo de la base de datos del servicio Backup Bach</p>', 'Activo', 'assets/imagenes/servicio/default.jpg', '<p>Características de Respaldo masivo de la base de datos del servicio Backup Bach</p>');
...
#
# TABLE STRUCTURE FOR: servicio_costo_detalle
#

DROP TABLE IF EXISTS servicio_costo_detalle;
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COMMENT='Representa todos los procesos que se encuentrarán asociados a un servicio previamente definido';

INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (14, 'Proceso de Negocio 1', 'Critica', NULL, 0);
INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (15, 'Proceso de Negocio 2', 'Critica', NULL, 0);
INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (16, 'Proceso de Negocio 3', 'Alta', NULL, 0);
INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (17, 'Proceso de Negocio 4', 'Media', NULL, 0);
INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (18, 'Proceso de Negocio 5', 'Baja', NULL, 0);
INSERT INTO servicio_proceso (`servicio_proceso_id`, `nombre`, `tipo`, `descripcion`, `borrado`) VALUES (19, 'PP-remot-001', 'Critica', NULL, 0);
...
INSERT INTO system_alerts (`alerta_id`, `id_module`, `prioridad`, `categoria`, `descripcion`, `href`, `activa`, `timestamp`) VALUES (2, 5, 'Danger', 'Continuidad', 'Se ha activado un Plan de Continuidad del Negocio', 'http://sigitec/index.php/continuidad/listado_pcn/alta', 0, '2014-10-10 16:17:13');
...
INSERT INTO tipo_estrategiasrecuperacion (`id_tipoestrategia`, `denominacion`, `parentesis`, `descripcion`, `costo`, `hardware`, `telecom`, `tiempo`) VALUES (7, 'Reutilización', 'Espacios y personal propios', 'Se asignan tareas críticas a personal de la organización que atienen tareas menos críticas o de otros departamentos. Se reutiliza cualquier componente de la organización, necesario para la recuperación.', 'Bajo', 'Parcial', 'Incierto', 'Necesario');
